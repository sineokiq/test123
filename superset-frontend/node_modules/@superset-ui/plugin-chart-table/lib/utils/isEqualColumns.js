...
function isEqualColumns(propsA, propsB) {
  const a = propsA[0];
  const b = propsB[0];
  return a.datasource.columnFormats === b.datasource.columnFormats && a.datasource.verboseMap === b.datasource.verboseMap && a.formData.tableTimestampFormat === b.formData.tableTimestampFormat && a.formData.timeGrainSqla === b.formData.timeGrainSqla && (0, _isEqualArray.default)(a.formData.metrics, b.formData.metrics) && (0, _isEqualArray.default)(a.formData.groupby, b.formData.groupby) && (0, _isEqualArray.default)(a.formData.allColumns, b.formData.allColumns);
}