...
import superset.oauth2client
from superset.oauth2client import _helpers
from superset.oauth2client import _pkce
from superset.oauth2client import clientsecrets
from superset.oauth2client import transport
...
class GoogleCredentials(OAuth2Credentials):
    ...
    def __init__(self, access_token, client_id, client_secret, refresh_token,
                 ...
                 revoke_uri=superset.oauth2client.GOOGLE_REVOKE_URI):
...
class AssertionCredentials(GoogleCredentials):
    ...
    def __init__(self, assertion_type, user_agent=None,
                 token_uri=superset.oauth2client.GOOGLE_TOKEN_URI,
                 revoke_uri=superset.oauth2client.GOOGLE_REVOKE_URI,
                 **unused_kwargs):
...
def credentials_from_code(client_id, client_secret, scope, code,
                          ...
                          user_agent=None,
                          token_uri=superset.oauth2client.GOOGLE_TOKEN_URI,
                          auth_uri=superset.oauth2client.GOOGLE_AUTH_URI,
                          revoke_uri=superset.oauth2client.GOOGLE_REVOKE_URI,
                          device_uri=superset.oauth2client.GOOGLE_DEVICE_URI,
                          token_info_uri=superset.oauth2client.GOOGLE_TOKEN_INFO_URI,
                          pkce=False,
                          code_verifier=None):
