  ...
  Object.entries(formData).forEach(([key, value]) => {
    ...
    if (normalizedKey in finalQueryFields) {
      if (normalizedKey === 'metrics') {
        ...
        finalQueryFields[normalizedKey] = finalQueryFields[normalizedKey].concat(value).filter(x => typeof x === 'string' && x);
      }
    }
  });

  if (formData.include_time && !finalQueryFields.groupby.includes(_buildQueryObject.DTTM_ALIAS)) {
    finalQueryFields.groupby.unshift(_buildQueryObject.DTTM_ALIAS);
  }
