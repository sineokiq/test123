...
const isEqualColumns = (propsA, propsB) => {
  ...
  const a = propsA[0];
  const b = propsB[0];
  return a.datasource.columnFormats === b.datasource.columnFormats && a.datasource.verboseMap === b.datasource.verboseMap && a.formData.tableTimestampFormat === b.formData.tableTimestampFormat && a.formData.timeGrainSqla === b.formData.timeGrainSqla && isEqualArray(a.formData.metrics, b.formData.metrics) && isEqualArray((_a$queriesData = a.queriesData) == null ? void 0 : (_a$queriesData$ = _a$queriesData[0]) == null ? void 0 : (_a$queriesData$$data = _a$queriesData$.data) == null ? void 0 : _a$queriesData$$data.columns, (_b$queriesData = b.queriesData) == null ? void 0 : (_b$queriesData$ = _b$queriesData[0]) == null ? void 0 : (_b$queriesData$$data = _b$queriesData$.data) == null ? void 0 : _b$queriesData$$data.columns);
};
