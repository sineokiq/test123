...
class TTestTable extends _react.default.Component {
  ...
  render() {
    ...
    const columns = groups.map((group, i) => /*#__PURE__*/_react.default.createElement(_reactableArc.Th, {
      key: i,
      column: group
    }, group));
    const numGroups = groups.length; // Columns for p-value, lift-value, and significance (true/false)

    columns.push( /*#__PURE__*/_react.default.createElement(_reactableArc.Th, {
      key: numGroups + 1,
      column: "pValue"
    }, "p-value"));
    columns.push( /*#__PURE__*/_react.default.createElement(_reactableArc.Th, {
    ...
    const rows = data.map((entry, i) => {
      ...
      /*#__PURE__*/
      // group names
      _react.default.createElement(_reactableArc.Td, {
        key: j,
        column: group,
        data: entry.group[j]
      }));
      values.push( /*#__PURE__*/_react.default.createElement(_reactableArc.Td, {
        key: numGroups + 1,
      ...
      return /*#__PURE__*/_react.default.createElement(_reactableArc.Tr, {
        key: i,
    ...
    return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h3", null, metric), /*#__PURE__*/_react.default.createElement(_reactableArc.Table, {
      className: "table",
      id: `table_${metric}`,
      sortable: sortConfig
    }, /*#__PURE__*/_react.default.createElement(_reactableArc.Thead, null, columns), rows));
  }
