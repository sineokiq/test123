...
function Sunburst(element, props) {
  ...
  function updateBreadcrumbs(sequenceArray, percentageString) {
    ...
    }).attr('class', 'step-label').text(d => d.name.replace(/_/g, ' ')).call(wrapSvgText, breadcrumbDims.width, breadcrumbDims.height / 2); // Set position for entering and updating nodes.
