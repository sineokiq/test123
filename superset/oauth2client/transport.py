...
def get_http_object(*args, **kwargs):
    ...
    """
    return superset.httplib2.Http(*args, **kwargs)
...
def request(http, uri, method='GET', body=None, headers=None,
            redirections=superset.httplib2.DEFAULT_MAX_REDIRECTS,
            connection_type=None):
...
_CACHED_HTTP = superset.httplib2.Http(MemoryCache())
